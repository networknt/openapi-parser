...
public class SecuritySchemeImpl extends PropertiesOverlay<SecurityScheme> implements SecurityScheme {
  ...
  protected void _elaborateJson() {
    ...
    _createScalar("implicitOAuthFlow", "flows/implicit", OAuthFlowImpl.factory);
    _createScalar("passwordOAuthFlow", "flows/password", OAuthFlowImpl.factory);
    _createScalar("clientCredentialsOAuthFlow", "flows/clientCredentials", OAuthFlowImpl.factory);
    _createScalar("authorizationCodeOAuthFlow", "flows/authorizationCode", OAuthFlowImpl.factory);
    _createMap("oAuthFlowsExtensions", "flows", ObjectOverlay.factory, "x-.+");
