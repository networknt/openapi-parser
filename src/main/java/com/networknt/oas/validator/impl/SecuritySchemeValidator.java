  ...
  public void runObjectValidations() {
    ...
    if (type != null) {
      ...
      case "apiKey":
        ...
        break;
      case "oauth2": {
        validateField(F_implicitOAuthFlow, false, OAuthFlow.class, new ImplicitOAuthFlowValidator());
        validateField(F_passwordOAuthFlow, false, OAuthFlow.class, new PasswordOAuthFlowValidator());
        validateField(F_clientCredentialsOAuthFlow, false, OAuthFlow.class, new ClientCredentialsOAuthFlowValidator());
        validateField(F_authorizationCodeOAuthFlow, false, OAuthFlow.class, new AuthorizationCodeOAuthFlowValidator());
        break;
      }
      case "openIdConnect":
